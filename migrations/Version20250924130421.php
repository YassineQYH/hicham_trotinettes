 ...
 */
final class Version20250924130421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE accessory (id INT AUTO_INCREMENT NOT NULL, model_trotinette_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, is_best TINYINT(1) NOT NULL, INDEX IDX_A1B1251CC93EA6F2 (model_trotinette_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE illustration (id INT AUTO_INCREMENT NOT NULL, trotinette_id INT NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_D67B9A4264F0FC18 (trotinette_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE model_trotinette (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, is_best TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trotinette (id INT AUTO_INCREMENT NOT NULL, model_trotinette_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, is_best TINYINT(1) NOT NULL, INDEX IDX_F3E399CEC93EA6F2 (model_trotinette_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE illustration ADD CONSTRAINT FK_D67B9A4264F0FC18 FOREIGN KEY (trotinette_id) REFERENCES trotinette (id)');
